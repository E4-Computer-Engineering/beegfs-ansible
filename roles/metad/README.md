...
It is compatible with the Beegfs versions specified in the role `metad_beegfs_version` variable choices and RedHat, Almalinux and Rocky 8.X 9.X and Ubuntu 22.04 (Jammy) and 24.04 (Noble) LTS.
